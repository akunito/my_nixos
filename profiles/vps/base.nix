...

{
  ...
  ++ lib.optional ((systemSettings.docsSites or { }) != { }) ../../system/app/docs-sites.nix # baby./home.local.akunito.com: pull the private docs repos from git, build, publish (no rebuild per page)
