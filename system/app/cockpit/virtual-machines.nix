...
stdenv.mkDerivation rec {
  ...
  version = "317"; # adjust version if > https://github.com/cockpit-project/cockpit-machines/releases
  src = fetchzip {
    url = "https://github.com/cockpit-project/cockpit-machines/releases/download/${version}/cockpit-machines-${version}.tar.xz";
    sha256 = "sha256-r6wRdKzw8tvZdJ8IeIZp6hRuyXv/WlWBTjddpsZHOcI="; # adjust sha256 if needed (work around until find better way: When build/switching nixos it will be shown)
  };
