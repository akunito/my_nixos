...
This phase requires SSH access to Komi's Proxmox (192.168.8.3).

### Container Specifications

| CTID | Profile | Cores | RAM (MB) | Disk (GB) | IP |
|------|---------|-------|----------|-----------|-----|
| 110 | KOMI_LXC_database | 2 | 4096 | 30 | 192.168.8.10 |
| 111 | KOMI_LXC_mailer | 1 | 1024 | 10 | 192.168.8.11 |
| 112 | KOMI_LXC_monitoring | 2 | 2048 | 20 | 192.168.8.12 |
| 113 | KOMI_LXC_proxy | 1 | 1024 | 10 | 192.168.8.13 |
| 114 | KOMI_LXC_tailscale | 1 | 1024 | 8 | 192.168.8.14 |

### Clone and Configure

Execute on `ssh -A root@192.168.8.3`:
...
memory: 4096
net0: name=eth0,bridge=vmbr0,ip=192.168.8.10/24,gw=192.168.8.1,type=veth
ostype: nixos
...
memory: 1024
net0: name=eth0,bridge=vmbr0,ip=192.168.8.11/24,gw=192.168.8.1,type=veth
ostype: nixos
...
memory: 2048
net0: name=eth0,bridge=vmbr0,ip=192.168.8.12/24,gw=192.168.8.1,type=veth
ostype: nixos
...
hostname: komi-proxy
memory: 1024
net0: name=eth0,bridge=vmbr0,ip=192.168.8.13/24,gw=192.168.8.1,type=veth
ostype: nixos
...
memory: 1024
net0: name=eth0,bridge=vmbr0,ip=192.168.8.14/24,gw=192.168.8.1,type=veth
ostype: nixos
...
- [ ] Each container boots and is reachable via `ssh admin@192.168.8.{10-14}`
