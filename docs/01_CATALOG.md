...
- **docs/akunito/plans/plane-test-suite/catalog.md**: Plane fork regression suite — full test catalogue by layer, mapped to register IDs A-xx/B-xx, with combination matrices
