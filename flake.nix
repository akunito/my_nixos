  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      systemSettings = {
        ...
        ipAddress = "192.168.0.70"; # static ip address to be assigned if dhcp is set to false
        ...
        wifiIpAddress = "192.168.0.71"; # static ip address to be assigned if dhcp is set to false
      ...
      userSettings = rec {
        ...
        sshAllowUsers = "aga"; # SSH allowed users
