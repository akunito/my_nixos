{
  description = "Flake of Akunito HomeLab K3S Cluster, node 1";
  ...
  outputs = inputs@{ self, ... }:
    ...
    let
      ...
      systemSettings = {
        ...
        # Firewall
        firewall = true;
        allowedTCPPorts = [ ]; # 80 443 8040 8043 nginx 2321 gitea 22000 syncthing 111 4000 4001 4002 2049 NFS
        allowedUDPPorts = [ ]; # 22000 syncthing 21027 syncthing 111 4000 4001 4002 NFS
